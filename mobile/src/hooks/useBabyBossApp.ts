...
export function useBabyBossApp() {
  ...
  return {
    ...
    sessionRecoveryRequired: runtime.sessionRecoveryRequired,
    ...
    retrySessionRestore: runtime.retrySessionRestore,
    ...
    isCurrentSessionScope: runtime.isCurrentSessionScope,
