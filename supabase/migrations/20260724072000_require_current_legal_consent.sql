-- Existing users must acknowledge the latest documents before continuing in the app.
-- Keep the accepted versions in sync with mobile/src/legalDocuments.ts.
...
create or replace function public.accept_current_caregiver_legal_consents(
    p_terms_version text,
    p_privacy_version text
)
returns void
