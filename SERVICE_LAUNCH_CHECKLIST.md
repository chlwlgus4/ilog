...
| 정식 약관 및 개인정보 처리방침 | 진행 중 | 2026-07-26 버전의 앱·공개 웹 문서를 반영했고 재동의 흐름도 구현됨. 사업장 정보, 대표 연락처, 개인정보 보호 담당자 지정과 최종 전문가 검토가 남음 |
...
- [x] 개인정보 처리방침 초안을 정식 문서로 교체
  - 수집 항목, 처리 목적, 보유 기간, 가족 공유, 수탁자, 권리 행사와 보호 조치를 2026-07-26 문서 버전에 반영했습니다.
